...
$plugin->version  = 20200701;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->component = 'local_wsanalyticalsystem';
$plugin->cron     = 0;
$plugin->release = '2.0 (Build: 20200701)';
