...
use App\Orchid\Screens\Queue\LsaSourceQuestionListScreen;
...
$this->router->screen('queue-lsa-source', LsaSourceQuestionListScreen::class)->name('platform.lsasource.list');
